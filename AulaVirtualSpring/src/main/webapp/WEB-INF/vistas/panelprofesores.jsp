                        ...
                        <p class="card-text " >
                            <c:forEach var = "ExamenesProfesor" items="${Cuestionarios_Profesor}">
                                <div id='Grupos' >
                                    ...
                                    <p><a href='${pageContext.request.contextPath}/ExamenGrupo/${ExamenesProfesor.getExamenId()}/${ExamenesProfesor.getProfesorId()}'style='color:LawnGreen;'>Añadir a grupo</a></p>
                                </div>
                            </c:forEach>
