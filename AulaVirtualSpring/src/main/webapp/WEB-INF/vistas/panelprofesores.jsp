					...
					<div class="card-body" style="background-color:#FFA07A;">
                        <p class="card-text " >
                            <c:forEach var = "ExamenesProfesor" items="${Cuestionarios_Profesor}">
                                <div id='Grupos' >
                                    <p><a href="${pageContext.request.contextPath}/PanelCuestionario/${ExamenesProfesor.getExamenId()}/${ExamenesProfesor.getNombre_Examen()}" style="color:black;">Titulo:${ExamenesProfesor.getNombre_Examen()} </a></p>
                                </div>
                            </c:forEach>
